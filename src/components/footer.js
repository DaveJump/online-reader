	...
	render(){
		...
		return(
			<footer className="bottom-nav">
				<div className="catalog" onClick={Controller.toggleCatalog.bind(this)}>
					<div className="icon-catalog"></div>
					<div className="text-catalog">目录</div>
				</div>

				<div className="pageStyle" onClick={Controller.togglePanel.bind(this)}>
					<div className="icon-pageStyle"></div>
					<div className="text-pageStyle">样式</div>
				</div>

				<div className="mod" onClick={Controller.changeMod.bind(this)}>
